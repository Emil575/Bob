...
//         const GuildSett = client.bob.has(nP.guild.id, `Status`)
//         if(!GuildSett) return
//         const GuildSettings = client.bob.get(np.guild.id)
//         let textInStats = GuildSettings.Status.Text
//         let guildId = GuildSettings.GuildId
//         let roleId = GuildSettings.Status.Role
